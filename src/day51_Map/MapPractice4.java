...
public class MapPractice4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(groups.get(2).get(1)); // second student of group 2


        System.out.println("------------------------------------------------");

        for (ArrayList<String> eachGroups : groups.values()) {//we use for each loop to get the groups
            for (String eachName : eachGroups) {//we use for each loop again to get the names
