...
public class ArraysUtility {
    ...
    public static boolean contains(String[] array, String element) {
        boolean result = false;
        for (String each : array) {
            if (each.equals(element)) { // if any array's element is matching with the given element, it means the given element is contained in the array
                result = true;
            }
        }
