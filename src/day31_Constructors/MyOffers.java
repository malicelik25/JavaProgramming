...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer5.setInfo("WA", "Bnak Of America", "BA", 100000, true, true, false, true);
        ...
        fullTimeOffers.removeIf(p -> !p.isFullTime); // removes the offer if the offer not fullTime
        ...
        ArrayList<Offer> forSDETs = new ArrayList<>(Arrays.asList(myOffers));
        forSDETs.removeIf(p -> !p.jobTitle.equals("SDET"));

        System.out.println(forSDETs);
