...
public class ScrumTeam {
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", Total number of testers=" + testersList.size() + //Total number of testers and .size() added manually
                ", Total number of developers=" + devopsList.size() +//Total number of developers and .size() added manually
