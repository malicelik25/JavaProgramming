...
public class MyInfo {
    ...
    public static void main(String[] args) {
        ...
        String fullName = scan.nextLine();  //if the previous scanner' method that's used is not nextLine(), then we need to give one additional nextLine()
...
1. Create a class called MyInfo. Write a program that can ask the user to:
			...
			2. Enter your gender (String- One word ONLY==>next()) add--->nextLine()
			3. Enter your full name (String- Multiple words==>nextLine())
			4. Enter your phone number (long==>nextLong())
			5. Enter your zip code (int==>nextInt())   add---> nextLine()
			...
			9. Enter your building number (int==>nextInt()   add--->nextLine())
